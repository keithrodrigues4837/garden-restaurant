  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 space-y-5 text-forest/80">
        <p>
          {restaurant.name} brings an authentic North Indian culinary experience to Colva,
        ...
        <p>
          ...
          {restaurant.seating} guests, making it the perfect spot for intimate gatherings and
